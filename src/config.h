...
#define LD_SWITCH_X_SITE -L/usr/X11/lib

/* Define LD_SWITCH_X_SITE_AUX with an -R option in case it's needed (for
   Solaris, for example). */
#define LD_SWITCH_X_SITE_AUX -R/usr/X11/lib
...
#define PACKAGE_STRING "emacs 23.3"
...
/* If we're using X11/Mac/GNUstep, define some consequences.  */
